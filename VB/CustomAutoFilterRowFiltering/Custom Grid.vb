...
Namespace DXSample
    ...
    Public Class MyGridView
        ...
        Protected Overrides Function RaiseCustomRowFilter(ByVal listSourceRow As Integer, ByVal fit As Boolean) As Integer
            Dim result As Integer = MyBase.RaiseCustomRowFilter(listSourceRow,fit)
            ...
            Dim filterResult As FilterResult = DXSample.MyGridView.FilterResult.RowExists
            For Each filterPair As KeyValuePair(Of GridColumn, ColumnFilterInfo) In filteredColumns
                ...
                If filterInfo.Type <> ColumnFilterType.AutoFilter Then
                    Return CInt(DXSample.MyGridView.FilterResult.NotProcessed)
                End If
                filteredColumn = filterPair.Key
                If filteredColumn.ColumnType IsNot GetType(String) Then
                    filterResult = DXSample.MyGridView.FilterResult.NotProcessed
                    Continue For
                End If
                ...
                If operandType = AutoFilterCondition.Like OrElse operandType = AutoFilterCondition.Default Then
                    If Not processedString.StartsWith(filter) Then
                        filterResult = DXSample.MyGridView.FilterResult.RowNotExists
                    End If
                End If
